...
class ProductFilterSellerCubit extends Cubit<ProductFilterSellerState> {
  ProductFilterSellerCubit() : super(const ProductFilterSellerState());
  ...
  void resetAll() {
    ...
    emit(const ProductFilterSellerState());
