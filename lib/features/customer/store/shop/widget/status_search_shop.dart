...
class ShopsStatusSelector extends StatefulWidget {
  final Function(String) onChanged;

  const ShopsStatusSelector({super.key, required this.onChanged});

  @override
  State<ShopsStatusSelector> createState() => _ShopsStatusSelectorState();
}

class _ShopsStatusSelectorState extends State<ShopsStatusSelector> {
  String _selected = "الكل";

  static const _items = ["الكل", "حلاقة", "بيطرة", "ملحمة", "أعلاف", "أدوية"];
