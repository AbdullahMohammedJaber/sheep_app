...
class ProductStatusSellerSelector extends StatefulWidget {
  final Function(String) onChanged;

  const ProductStatusSellerSelector({super.key, required this.onChanged});

  @override
  State<ProductStatusSellerSelector> createState() => _ProductStatusSellerSelectorState();
}

class _ProductStatusSellerSelectorState extends State<ProductStatusSellerSelector> {
  String _selected = "الكل";

  static const _items = ["الكل", "نشط", "قيد المراجعة", "مُباع"];
